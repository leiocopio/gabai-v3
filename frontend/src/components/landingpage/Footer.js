          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a
                target="_blank"
                href="facebook.com"
                class="text-gray-500 hover:text-azure dark:hover:text-white"
              >
                <svg
                  class="w-4 h-4 fill-gray-500 hover:fill-azure"
                  aria-hidden="true"
              ...
              <a
                target="_blank"
                href="discord.com"
                class="text-gray-500 hover:text-azure dark:hover:text-white ms-5"
              >
                <svg
                  class="w-4 h-4 fill-gray-500 hover:fill-azure"
                  aria-hidden="true"
